...
import { useBlogByTitle } from '../_hooks/hook.client';
import { BlogDetailSkeleton } from '../_components/blog-detail-skeleton';
...
export function BlogDetailSection({ title }: Props) {
  const { data, isLoading, isError, error } = useBlogByTitle(title);
    ...
    return (
      <div className='container mx-auto'>
        <div className='mt-46 min-h-[40vh]'>
          ...
          <Reveal delay={0.1}>
            <h1 className='mt-8 font-semibold text-3xl'>Blog not found</h1>
